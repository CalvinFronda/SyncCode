...
import { executePython, ExecutionResult } from "../api/execute";
        ...
        <div className="modal">
          ...
          <div className="input-group">
            <input
              ...
              onKeyDown={(e) => {
                 if (e.key === "Enter" && inputName.trim()) setUsername(inputName);
              }}
            />
            <button 
    ...
    <div className="app">
      <header className="app-header">
        ...
        <div className="header-controls">
            <button onClick={() => navigator.clipboard.writeText(window.location.href)} className="share-button">
            Share Link
            </button>
      ...
      <div className="main-content">
        <div className="editor-output-split">
            ...
            <h2>Output</h2>
            <Output result={output} isRunning={isRunning} triggeredBy={triggeredBy} />
            </div>
        </div>
        
        <div className="bottom-panel">
            <UserList users={users} currentUser={{ name: username, color: userColor }} />
        </div>
      </div>
    </div>
  );
